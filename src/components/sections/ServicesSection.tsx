...
export default function ServicesSection({ services, isInView = false }: ServicesSectionProps) {
  return (
              ...
              <Card className="group h-full hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border border-gray-100 overflow-hidden">
                <Link href={service.link} className="block h-full">
                  <div className="relative h-48 overflow-hidden">
                    ...
                    {service.price && (
                      <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm rounded-full px-3 py-1 text-sm font-medium text-dental-800">
