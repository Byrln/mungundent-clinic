          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10">
              <div className="inline-flex items-center px-3 py-1 mb-6 rounded-md bg-dental-50 border-l-4 border-dental-500">
                <span className="text-dental-700 font-medium text-sm">
                  Бидэнтэй холбогдох
                </span>
              </div>
              ...
              >
                Асуулт, санал хүсэлт байвал бидэнтэй холбогдоорой. Бид таны
                асуултанд хариулахад таатай байх болно.
              </motion.p>
            </div>
            ...
            >
              <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg border border-gray-100">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">+976 7720 0888</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg border border-gray-100">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">mungundent@gmail.com</p>
                </div>
              </div>
              ...
              {isSuccess ? (
                ...
                >
                  ...
                  <p className="text-gray-600 mb-8 max-w-md mx-auto">
                    Таны мессежийг хүлээн авлаа. Бид удахгүй тантай холбогдох
                    болно.
                  </p>
                  <Button
                ...
                <div className="bg-white rounded-xl shadow-lg p-5 md:p-8 border border-gray-100">
                  ...
                  <h2 className="text-xl sm:text-2xl font-bold mb-6 text-dental-800">
            ...
            >
              ...
              <motion.div variants={fadeIn} className="space-y-4 md:space-y-6">
                <div className="flex items-start space-x-4 bg-dental-50/50 p-4 rounded-xl hover:bg-dental-50 transition-colors">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Улаанбаатар хот, ХУД, Маршал хотхон, King Tower-125
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 bg-dental-50/50 p-4 rounded-xl hover:bg-dental-50 transition-colors">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1 text-dental-700">
                      Facebook
                    </h3>
                    <p className="text-gray-600 text-sm">
                      <a
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10">
              ...
              <h2 className="text-2xl md:text-3xl font-bold mb-4 text-dental-800">
                Түгээмэл асуултууд
              </h2>
              <p className="text-gray-600 max-w-xl mx-auto text-sm sm:text-base">
                Үйлчлүүлэгчдийн түгээмэл асуудаг асуултуудын хариултыг доор
                оруулав
              </p>
            </div>
            ...
            <div className="space-y-4 md:space-y-6">
              <div className="bg-white p-5 md:p-6 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all">
                <h3 className="font-semibold text-base md:text-lg mb-2 text-dental-800">
                  Цаг захиалахын тулд урьдчилан төлбөр төлөх шаардлагатай юу?
                </h3>
                <p className="text-gray-600 text-sm md:text-base">
                  Үгүй, цаг захиалахад урьдчилан төлбөр төлөх шаардлагагүй.
                  Гэхдээ цаг захиалсан бол ирэх боломжгүй тохиолдолд 24 цагийн
                  өмнө мэдэгдэхийг хүсье.
                </p>
              </div>

              <div className="bg-white p-5 md:p-6 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all">
                <h3 className="font-semibold text-base md:text-lg mb-2 text-dental-800">
                  Та нар даатгалтай ажилладаг уу?
                </h3>
                <p className="text-gray-600 text-sm md:text-base">
                  Тийм, бид зарим эрүүл мэндийн даатгалтай хамтран ажилладаг.
                  Тодорхой мэдээлэл авахыг хүсвэл бидэнтэй холбогдоорой.
                </p>
              </div>
              ...
              <div className="bg-white p-5 md:p-6 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600 text-sm md:text-base">
                  Яаралтай тохиолдолд манай утсаар шууд холбогдоно уу: +976
                  99112233. Ажлын цагаар бид аль болох хурдан хариу өгөхийг
                  хичээх болно.
                </p>
              </div>
              ...
              <div className="bg-white p-5 md:p-6 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all">
                <h3 className="font-semibold text-base md:text-lg mb-2 text-dental-800">
                  Та нар хүүхдийн шүдний эмчилгээ хийдэг үү?
                </h3>
                <p className="text-gray-600 text-sm md:text-base">
                  Тийм, бид хүүхдийн шүдний эмчилгээнд мэргэшсэн. Манай эмч нар
                  хүүхдэд ээлтэй арга барилаар ажилладаг бөгөөд тусгай
                  сургалтанд хамрагдсан. Дэлгэрэнгүй мэдээллийг{" "}
                  <Link
                    href="/children-dentistry"
                    className="text-dental-600 hover:underline font-medium"
                  >
                    энд дарж
                  </Link>{" "}
                  авна уу.
      ...
      <section className="py-16 md:py-24 bg-gradient-to-r from-dental-500 to-[#86EFAC] text-white">
        <div className="container mx-auto px-4 md:px-6 text-center">
          <h2 className="text-3xl font-bold mb-6">
            Эрүүл шүд, гэрэл инээмсэглэлийн төлөө
          </h2>
          <p className="text-lg mb-8 max-w-2xl mx-auto">
            Мэргэжлийн шүдний эмчилгээ, зөвлөгөө авахыг хүсвэл бидэнтэй
            холбогдоорой.
          </p>
          <Button
            asChild
            size="lg"
            className="bg-white text-dental-600 hover:bg-gray-100"
          >
            <a href="tel:+97677200888">
